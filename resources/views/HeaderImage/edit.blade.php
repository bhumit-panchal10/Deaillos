...
@section('content')
        ...
        <div class="container-fluid group-data-[content=boxed]:max-w-boxed mx-auto">
            ...
            <div class="flex flex-col gap-2 py-4 md:flex-row md:items-center print:hidden">
                ...
                <ul class="flex items-center gap-2 text-sm font-normal shrink-0">
                    ...
                    <li
                        class="relative before:content-['\ea54'] before:font-remix ltr:before:-right-1 rtl:before:-left-1  before:absolute before:text-[18px] before:-top-[3px] ltr:pr-4 rtl:pl-4 before:text-slate-400 dark:text-zink-200">
                        <a href="{{ route('offerimage.index') }}" class="text-slate-400 dark:text-zink-200">Header Image
                            List</a>
                    </li>
                                ...
                                <div class="rtl:md:text-start">
                                    <div class="bg-white shadow rounded-md dark:bg-zink-600">
                                        <div
                                            ...
                                            <h5 class="text-16" id="exampleModalLabel">Edit Header Image</h5>
                                            <a href="{{ route('headerimage.index') }}">
                                                <button type="button"
                                        ...
                                        <div class="max-h-[calc(theme('height.screen')_-_180px)] overflow-y-auto p-4">
                                            <form onsubmit="return EditvalidateFile()" class="tablelist-form"
                                                action="{{ route('headerimage.update', $image->id) }}" method="POST"
                                                enctype="multipart/form-data">
                                                @csrf

                                                <input type="hidden" name="header_image_id" id="header_image_id"
                                                    value="{{ $image->header_image_id }}">
                                                ...
                                                <div class="grid grid-cols-3 gap-4">
                                                    ...
                                                    <div class="mb-3 ">
                                                        ...
                                                        <input type="file" id="editmain_img" name="editmain_img"
                                                            ...
                                                            autocomplete="off">
                                                        <div id="viewimg">
                                                            <img src="{{ asset('upload/headerImage/') . '/' . $image->header_image }}"
                                                                height="70" width="70" alt="">

                                                        </div>
                                                    </div>
                                                    <input type="hidden" name="hiddenPhoto" class="form-control"
                                                        value="{{ old('editmain_img') ? old('editmain_img') : $image->header_image }}"
                                                        id="hiddenPhoto">
    ...
    <script>
        function EditvalidateFile() {
            //alert('hello');
            var allowedExtension = ['jpeg', 'svg', 'jpg', 'png', 'webp', ''];
