...
<div
    ...
    <div class="container-fluid group-data-[content=boxed]:max-w-boxed mx-auto">
        ...
        <div class="flex flex-col gap-2 py-4 md:flex-row md:items-center print:hidden">
            <div class="grow">
                <h5 class="text-16">Categories List</h5>
            </div>
                            ...
                            <div class="rtl:md:text-start">
                                <div class="bg-white shadow rounded-md dark:bg-zink-600">
                                    <div
                                        ...
                                        <h5 class="text-16" id="exampleModalLabel">Add Categories</h5>
                                    </div>
                                        ...
                                        <form method="POST" onsubmit="return validateFile()"
                                            ...
                                            <div class="mb-3">
                                                <label for="email-field"
                                                    ...
                                                    Image</label>
                                                <input type="file" id="Categoryimg" name="Categoryimg"
                                                    maxlength="150"
                                                    class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200"
                                                    placeholder="Enter Categories Img" autocomplete="off" autofocus>
                                            </div>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="file" id="Categoryicon" name="Categoryicon"
                                                    maxlength="150"
                                                    class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200"
                                ...
                                <table class="w-full whitespace-nowrap" id="customerTable">
                                    <thead class="bg-slate-100 dark:bg-zink-600">
                                        <tr>
                                            ...
                                            <th class="sort px-3.5 py-2.5 font-semibold border-b border-slate-200 dark:border-zink-500 "
                                                data-sort="state_name">Category Icon </th>
                                    ...
                                    <tbody class="list form-check-all">
                                        ...
                                        <tr class="text-center">
                                            ...
                                            <td
                                                ...
                                                <img class="img-fluid"
                                                    src="{{ asset('upload/category-images') . '/' . $category->Categories_img }}"
                ...
                <div class="max-h-[calc(theme('height.screen')_-_180px)] overflow-y-auto p-4">
                    <form class="tablelist-form" onsubmit="return EditvalidateFile()"
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="Category_name" id="EditCategoryName" maxlength="150"
                                class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200"
                        ...
                        <div class="mb-3">
                            ...
                            <input type="file" name="Categoryimg" id="EditCategoryimg" maxlength="150"
                                class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200"
                        ...
                        <div class="mb-3">
                            <label for="Categoryicon-field" class="inline-block mb-2 text-base font-medium">Category
                                Icon</label>
        ...
        if (id) {
            $.ajax({
                ...
                success: function(data) {
                    ...
                    var imageUrl = obj.Categories_img ? "{{ asset('upload/category-images') }}/" + obj
                        .Categories_img : "{{ asset('assets/images/noimage.png') }}";

                    var imageUrlicon = obj.Categories_icon ? "{{ asset('upload/category-icons') }}/" + obj
                        .Categories_icon : "{{ asset('assets/images/noimage.png') }}";

                    $("#EditCategoryName").val(obj.Category_name);

                    $("#hiddenPhoto").val(obj.Categories_img ? obj.Categories_img : '');

                    $("#hiddeniconPhoto").val(obj.Categories_icon ? obj.Categories_icon : '');


                    $("#EditCategoryImage").attr('src', imageUrl);
                    $("#EditCategoryIcon").attr('src', imageUrlicon);
...
<script>
    function validateFile() {
        ...
        var fileExtension = document.getElementById('Categoryimg').value.split('.').pop().toLowerCase();
...
<script>
    function EditvalidateFile() {
        //alert('hello');
        var allowedExtension = ['jpeg', 'jpg', 'png', 'webp', ""];
        var fileExtension = document.getElementById('EditCategoryimg').value.split('.').pop().toLowerCase();
        var isValidFile = false;
        var image = document.getElementById('EditCategoryimg').value;
        for (var index in allowedExtension) {
            if (fileExtension === allowedExtension[index]) {
                isValidFile = true;
                break;
