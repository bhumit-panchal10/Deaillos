...
@section('title', 'Edit Offer Image')
@section('content')
    {!! Toastr::message() !!}
        ...
        <div class="container-fluid group-data-[content=boxed]:max-w-boxed mx-auto">
            ...
            <div class="flex flex-col gap-2 py-4 md:flex-row md:items-center print:hidden">
                ...
                <ul class="flex items-center gap-2 text-sm font-normal shrink-0">
                    ...
                    <li
                        class="relative before:content-['\ea54'] before:font-remix ltr:before:-right-1 rtl:before:-left-1  before:absolute before:text-[18px] before:-top-[3px] ltr:pr-4 rtl:pl-4 before:text-slate-400 dark:text-zink-200">
                        <a href="{{ route('offerimage.index') }}" class="text-slate-400 dark:text-zink-200">Offer Image
                            List</a>
                    </li>
                                ...
                                <div class="rtl:md:text-start">
                                    <div class="bg-white shadow rounded-md dark:bg-zink-600">
                                        <div
                                            ...
                                            <h5 class="text-16" id="exampleModalLabel">Edit Offer Image</h5>
                                            <a href="{{ route('offerimage.index') }}">
                                                <button type="button"
                                        ...
                                        <div class="max-h-[calc(theme('height.screen')_-_180px)] overflow-y-auto p-4">
                                            <form onsubmit="return EditvalidateFile()" class="tablelist-form"
                                                action="{{ route('offerimage.update', $image->id) }}" method="POST"
                                                enctype="multipart/form-data">
                                                @csrf

                                                <input type="hidden" name="offerimage_id" id="offerimage_id"
                                                    value="{{ $image->offerimage_id }}">
                                                ...
                                                <div class="grid grid-cols-3 gap-4">
                                                    ...
                                                    <div class="mb-3 ">
                                                        ...
                                                        <input type="file" id="editmain_img" name="editmain_img"
                                                            ...
                                                            autocomplete="off">
                                                        <div id="viewimg">
                                                            <img src="{{ asset('upload/offerImage/') . '/' . $image->offer_image }}"
                                                                height="70" width="70" alt="">

                                                        </div>
                                                    </div>
                                                    <input type="hidden" name="hiddenPhoto" class="form-control"
                                                        value="{{ old('editmain_img') ? old('editmain_img') : $image->offer_image }}"
                                                        id="hiddenPhoto">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" name="link" id="link"
                                                            value="{{ $image->link }}" maxlength="150"
                                                            class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200"
                                                            placeholder="Enter link" autocomplete="off" autofocus>

                                                    </div>
                                                    <div class="mb-3">
                                                        <label for="Categoryimage-field"
                                                            class="inline-block mb-2 text-base font-medium">
                                                            Display Offer Top & Bottom</label>
                                                        ...
                                                        <select name="display_homepage"
                                                            ...
                                                            <option value="1"
                                                                @if ($image->is_align == 1) selected @endif>Top
                                                            </option>
                                                            <option value="2"
                                                                @if ($image->is_align == 2) selected @endif>Bottom
                                                            </option>
                                                        </select>
