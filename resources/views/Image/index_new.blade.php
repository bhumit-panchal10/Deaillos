...
@section('content')
    ...
    <div
        ...
        <div class="container-fluid group-data-[content=boxed]:max-w-boxed mx-auto">
            ...
            <div class="flex flex-col gap-2 py-4 md:flex-row md:items-center print:hidden">
                <div class="grow">
                    <h5 class="text-16">Image List</h5>
                </div>
                                ...
                                <div class="rtl:md:text-start">
                                    <div class="bg-white shadow rounded-md dark:bg-zink-600">
                                        <div
                                            ...
                                            <h5 class="text-16" id="exampleModalLabel">Add Image List</h5>
                                        </div>
                                        <div class="max-h-[calc(theme('height.screen')_-_180px)] overflow-y-auto p-4">
                                            <form method="POST" onsubmit="return validateFile()"
                                                action="{{ route('image.store') }}" id="registerForm"
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <select id="Categoryid" name="Categoryid" onchange="getsubcategory();"
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="hidden" name="hiddenPhoto" id="hiddenPhoto"
                                                        value="">

                                                    {{-- <img class="img-fluid" src="" alt="" height="50"
                                                        width="50" id="EditImg"> --}}
                                                </div>
            ...
            <div id="EditModal" modal-center=""
                ...
                <div class="w-screen md:w-[30rem] bg-white shadow rounded-md dark:bg-zink-600">
                    <div class="flex items-center justify-between p-4 border-b border-slate-200 dark:border-zink-500">
                        <h5 class="text-16" id="exampleModalLabel">Edit Image</h5>
                    ...
                    <div class="max-h-[calc(theme('height.screen')_-_180px)] overflow-y-auto p-4">
                        <form class="tablelist-form" onsubmit="return EditvalidateFile()"
                            action="{{ route('image.update') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="mb-3">
                                ...
                                <select id="editCategoryid" name="editCategoryid" onchange="editGetSubcategory();"
                                    class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200"
                                    required>
                                    <option value="" disabled selected>Select a Category</option>
                                    @foreach ($categories as $category)
                            ...
                            <div class="mb-3">
                                ...
                                <select id="editAreasubCategoryid" name="editAreasubCategoryid"
                                    class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200">
                                    <option value="" disabled selected>Select a SubCategory
                                    </option>
                                    @foreach ($subcategories as $subcategory)
                            ...
                            <div class="mb-3">
                                <label for="Categoryimage-field" class="inline-block mb-2 text-base font-medium">
                                    Image</label>
    ...
    <script>
            ...
            if (id) {
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        $("#hiddensubicon").val(obj.subCategories_icon ? obj.subCategories_icon : '');
        ...
        function getsubcategory() {
            ...
            var url = "{{ route('image.category_subcategory_mapping', ':categoryid') }}";
        ...
        function editGetSubcategory() {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $("#editAreasubCategoryid").html('');
                    $("#editAreasubCategoryid").append(
                        '<option value="" disabled selected>Select Subcategory</option>');

                    $.each(data.subcategories, function(key, value) {
                        $("#editAreasubCategoryid").append(
                            '<option value="' + value.iSubCategoryId + '">' + value
                            .strSubCategoryName + '</option>'
                        );
                    });
                },
                error: function() {
