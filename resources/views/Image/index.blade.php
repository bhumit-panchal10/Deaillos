                    ...
                    <div class="card-body">
                        <div class="grid grid-cols-1 gap-5 mb-5 xl:grid-cols-0">
                            ...
                            <div class="rtl:md:text-start">
                                ...
                                @endif
                                <a class="mx-1 ltr:md:text-end" title="Add New Career" href="{{ route('image.add') }}"
                                    style="float: inline-end;">
                                    <button type="submit"
                                        class="text-white transition-all duration-200 ease-linear btn bg-custom-500 border-custom-500 hover:text-white hover:bg-custom-600 hover:border-custom-600 focus:text-white focus:bg-custom-600 focus:border-custom-600 focus:ring focus:ring-custom-100 active:text-white active:bg-custom-600 active:border-custom-600 active:ring active:ring-custom-100 dark:ring-custom-400/20">
                                        <i class="ri-add-box-fill"></i> Add Image
                                    </button>
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="overflow-x-auto">
                            @if (!$image->isEmpty())
                            <form id="bulkDeleteForm" method="POST" action="{{ route('image.deleteselected') }}">
                                @csrf
                                @method('DELETE')
    ...
    function confirmSingleDelete(id) {
        Swal.fire({
            ...
            if (result.value) {
                ...
                fetch('{{ route("image.delete", ["id" => "__id__"]) }}'.replace('__id__', id), {
                        method: 'DELETE',
                        headers: {
                    ...
                    .then(data => {
                        if (data.success) {
                            Swal.fire({
                                ...
                                // Redirecting to the categories index page after successful deletion
                                window.location.href = '{{ route("image.index") }}';
                            });
                        } else {
                            Swal.fire({
                                title: 'Error!',
