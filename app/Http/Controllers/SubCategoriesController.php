...
class SubCategoriesController extends Controller
{
    ...
    {
        try {
            $subcategories = SubCategories::orderBy('strSubCategoryName', 'asc')->paginate(config('app.per_page'));
            // dd($subcategories);
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            if ($request->hasFile('SubCategoryimg')) {
                ...
                $destinationpath = $root . '/pricecut/upload/subcategory-images/';
            ...
            if ($request->hasFile('SubCategoryicon')) {
                ...
                $destinationPath = $root . '/pricecut/upload/subcategory-icons/';
