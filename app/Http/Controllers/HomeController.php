...
class HomeController extends Controller
{
    ...
    public function index()
    {
        ...
        $Vendor = Vendor::orderBy('vendor_id', 'asc')->count();
        $FaqMaster = FaqMaster::orderBy('id', 'asc')->count();
        $CMSMaster = CMSMaster::orderBy('id', 'asc')->count();
        $promocode = promocode::orderBy('id', 'asc')->count();
        $deal = Deals::orderBy('id', 'asc')->count();

        return view('dashboard.home', compact('Categories', 'promocode', 'deal', 'FaqMaster', 'CMSMaster', 'subcategory', 'states', 'cities', 'AreaMaster', 'Vendor'));
    }
